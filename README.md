...
A simple web app made from just JavaScript, HTML and CSS (bootstrap framework).
The javascript makes calls to an API that returns over 1000s cocktail details and instructions on how to make them.
